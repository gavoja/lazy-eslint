...
const FILES_JS = ['**/*.js', '**/*.mjs', '**/*.cjs', '**/*.jsx', '**/*.ts', '**/*.tsx']
const FILES_JSON = ['**/*.json', '**/*.jsonc', '**/*.json5']

const CONFIG = [
  // Mimic StandardJS without using Standard.
  // Include Sonar as well.
  {
    ...
    rules: {
      // StandardJS rules.
      // Source: https://github.com/standard/eslint-config-standard/blob/master/src/index.ts
      'no-var': 'warn',
      ...
      // 'quote-props': ['error', 'as-needed'], disabled, consistency is better.
      ...
      'sonarjs/todo-tag': 'off' // Allow TODO sections in the code. It is useful.
    }
  },
  // Add JSON rules.
  ...jsonc.configs['flat/recommended-with-jsonc'].map(config => config.files ? config : { ...config, files: FILES_JSON }),
  {
    files: FILES_JSON,
    rules: {
